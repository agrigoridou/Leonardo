...
responses = {
    ...
    "name": {
        ...
        "answers": [
            ...
            "Με λένε Ελ Γκρέκο, τον ψηφιακό σου βοηθό!"
        ],
        "emotion": "happy"
    },
    "capabilities": {
    ...
    "creator": {
        "keywords": ["ποιος σε εφτιαξε", "δημιουργησε", "απο που ηρθες"],
        "answers": [
...
def basic_response(text):
    ...
    if score >= 75:
        ...
        answer = random.choice(responses[matched_intent]["answers"])
        emotion = responses[matched_intent]["emotion"]
